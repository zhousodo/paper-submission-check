...
description: Pre-submission LaTeX paper checker for language, formatting, citations, BIB integrity, table markings, AI-style cleanup, and cross-section consistency. Use for journal or conference submission review.
---
